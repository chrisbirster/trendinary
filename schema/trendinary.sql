...
CREATE TABLE following_alert_context (
...
CREATE INDEX idx_following_alert_context_radar ON following_alert_context(radar_id);

CREATE TABLE following_alert_feedback (
  alert_id TEXT PRIMARY KEY,
  radar_id TEXT NOT NULL,
  rating TEXT NOT NULL,
  updated_at TEXT NOT NULL
);
CREATE INDEX idx_following_alert_feedback_radar ON following_alert_feedback(radar_id);

CREATE TABLE following_alert_delivery (
  alert_id TEXT PRIMARY KEY,
  radar_id TEXT NOT NULL,
...
CREATE INDEX idx_following_alert_delivery_radar ON following_alert_delivery(radar_id);

CREATE TABLE following_briefing_checkpoint (
  radar_id TEXT PRIMARY KEY,
